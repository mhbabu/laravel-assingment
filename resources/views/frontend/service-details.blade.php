...
<section class="hero-section">
  ...
  <div class="hero-section__content">
    <div class="container custom-container">
      <h1 class="big-heading">Consultancy and early design</h1>
    </div>
  </div>
</section>
<!-- sticky menu -->
  ...
  <div class="container custom-container">
    <div class="d-flex align-items-center">
      ...
      <div class="d-flex align-items-center">
        ...
        <a href="#relatedPublication" class="sticky-menu-item">Related publications</a>
    ...
    <div class="row">
      <div class="col-md-8 mx-auto">
        ...
        <div class="benefits__item">
          ...
          <p class="fs-18 ">Get a clear understanding of project constraints and opportunities. Plus: accurate data acquisition for less risk.</p>
        </div>
        <div class="benefits__item">
...
<!-- technical -->
<section class="technical related-pub mb-5" id="relatedPublication">
  <div class="container custom-container">
  ...
  <div class="container custom-container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <h2 style="color: rgb(129, 142, 160);" class="fs-48 mb-0">consultancy and early design</h2>
      </div>
    </div>
    <div class="row mt-5">
      <div class="col-12">
