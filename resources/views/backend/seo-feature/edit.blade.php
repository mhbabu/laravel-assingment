...
@section('title', 'Edit SEO Features')
@section('css')
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>SEO Feautures <div class="page-title-subheading"> Edit SEO Features</div>
                    </div>
                </div>
            </div>
        </div> 

        {!! Form::open(['route' => ['seo-features.update', $seoFeature->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'dataForm']) !!}
        <div class="card shadow mb-4">
            <div class="card-header">
                <h6 class="font-weight-bold"><i class="fa fa-edit"></i> Edit SEO Feature</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('title', $seoFeature->title, [ 'class' => 'required form-control ' . ($errors->has('title') ? 'is-invalid' : '')]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('page_name', $seoFeature->page_name, [ 'class' => 'required form-control page-name ' . ($errors->has('page_name') ? 'is-invalid' : '')]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('slug', $seoFeature->slug, [ 'class' => 'required form-control slug ' . ($errors->has('slug') ? 'is-invalid' : '')]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('seo_title', $seoFeature->seo_title, [ 'class' => 'required form-control ' . ($errors->has('slug_en') ? 'is-invalid' : '')]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('og_title', $seoFeature->og_title, [ 'class' => $errors->has('og_title') ? 'form-control is-invalid' : 'form-control required']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('twitter_title', 'Twitter Title: ', ['class' => 'required-star font-weight-bold']) !!}
                                {!! Form::text('twitter_title', $seoFeature->twitter_title, [ 'class' => $errors->has('twitter_title') ? 'form-control is-invalid' : 'form-control']) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('og_type', ['Website' => 'Website', 'E-commerce' => 'E-commerce', 'Industrial' => 'Industrial'], $seoFeature->og_type, [ 'class' => $errors->has('og_type') ? 'form-control is-invalid' : 'form-control required']) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('image_alt_text', $seoFeature->image_alt_text, [ 'class' => $errors->has('image_alt_text') ? 'form-control is-invalid' : 'form-control required']) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('og_image_alt_text', $seoFeature->og_image_alt_text, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('twitter_image_alt_text', 'Twitter Image Alt Text: ', [ 'class' => 'required-star font-weight-bold']) !!}
                                {!! Form::text('twitter_image_alt_text', $seoFeature->twitter_image_alt_text, ['class' => $errors->has('twitter_image_alt_text') ? 'form-control is-invalid' : 'form-control required']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('canonical_url', $seoFeature->canonical_url, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('keywords', 'Keywords: ', ['class' => 'required-star font-weight-bold']) !!}
                                {!! Form::text('keywords', $seoFeature->keywords, ['class' => 'required form-control keywords']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('og_description', 'OG Description: ', ['class' => 'required-star font-weight-bold']) !!}
                                {!! Form::textarea('og_description', $seoFeature->og_description, [ 'class' => $errors->has('og_description') ? 'form-control is-invalid' : 'form-control required', 'rows' => 4]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('meta_description', $seoFeature->meta_description, ['class' => $errors->has('meta_description') ? 'form-control is-invalid' : 'form-control required', 'rows' => 4]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('twitter_description', $seoFeature->twitter_description, [ 'class' => $errors->has('twitter_description') ? 'form-control is-invalid' : 'form-control required','rows' => 4]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <br />
                                <img class="img border image-view" src="{{ $seoFeature->image_path ? url($seoFeature->image_path) : url('assets/backend/images/img.png') }}" height="300" width="100%">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <br />
                                <img class="img border image-view" src="{{ $seoFeature->og_image_path ? $seoFeature->og_image_path : url('assets/backend/images/img.png') }}" height="300" width="100%">
                                <label class="btn btn-block btn- btn-primary btn-sm rounded-0 w-100" style="cursor: pointer">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <br />
                                <img class="img border image-view" src="{{ $seoFeature->twitter_image_path ? url($seoFeature->twitter_image_path) : url('assets/backend/images/img.png') }}" height="300" width="100%">
                                <label class="btn btn-block btn- btn-primary btn-sm rounded-0 w-100" style="cursor: pointer">
