...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
        <ol class="breadcrumb alert alert-info p-2">
            <li class="breadcrumb-item"><strong>Created By - </strong> <span>{{ ($userFile->createdBy->name) ? $userFile->createdBy->name .' (' . $userFile->createdBy->email .')' : '-' }} </span></li>
            <li class="breadcrumb-item"><strong>Created At - </strong> <span>{{ \Carbon\Carbon::parse($userFile->created_at)->format('d F , Y') }} at {{ \Carbon\Carbon::parse($userFile->created_at)->format('g:i A') }} </span></li>
        </ol>
        <div class="card-body">
