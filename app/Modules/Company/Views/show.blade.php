...
@section('content')
    <ol class="breadcrumb alert alert-info p-2">
        <li class="breadcrumb-item"><strong>Created By - </strong> <span>{{ ($company->user_name) ? $company->user_name : '-' }} </span></li>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 form-group">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-4 font-weight-bold"> Product Keyword </div>
                        <div class="col-lg-8"> {{ ($product->product_keyword) ? $product->product_keyword : '-' }} </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-4 font-weight-bold"> Warranty Duration </div>
                        <div class="col-lg-8"> {{ ($product->warranty_duration) ? $product->warranty_duration : '-' }} </div>
                    </div>
                    <div class="row mb-2">
